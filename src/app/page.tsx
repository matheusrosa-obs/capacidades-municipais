...
const AXES: AxisKey[] = ["Economia", "CapitalHumano", "QualidadeVida",
                         "Seguranca", "MeioAmbiente", "Saude", "Inovacao",
                         "Governanca", "Infraestrutura"];
  ...
  },
  {
    ...
    axes: {
      Economia: [
        ...
        { key: "vab_ind_pc", label: "VAB industrial per capita", value_0_20: 17.2 },
        { key: "pib_pc", label: "PIB per capita", value_0_20: 11.2 },
        { key: "emp_form", label: "Emprego formal", value_0_20: 14.7 },
        { key: "cresc_emp", label: "Crescimento do emprego", value_0_20: 11.2 },
        { key: "complex", label: "Complexidade econômica", value_0_20: 16.3 },
      ...
      CapitalHumano: [
        ...
        { key: "perf_eta", label: "Perfil etário", value_0_20: 10.9 },
        { key: "unis", label: "Universidades", value_0_20: 17.2 },
        { key: "niv_educ", label: "Nível educacional", value_0_20: 14.7 },
